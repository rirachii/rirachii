    ...
    <div className='content'>
        ...
        <section id='project'>
            ...
            <div className='projecto'>
                  {/* Project 1  */}
                <a href="https://streamdigitaltwin.netlify.app/" aria-label="GitHub" target="_blank" rel="noreferrer">
                ...
                <div className='project__des'>
                    ...
                    <div className='center' id='project__links'>      
                        ...
                        <a href="https://streamdigitaltwin.netlify.app/" aria-label="WebSite" target="_blank" rel="noreferrer">
                        <svg xmlns="http://www.w3.org/2000/svg"
                            role="img"
                            viewBox="0 0 32 32" fill="none" stroke="currentColor"
                            stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
